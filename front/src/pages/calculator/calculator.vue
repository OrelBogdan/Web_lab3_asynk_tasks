	...
	<div>
		<div class="row form-inline">
			<div class="form-floating w-100">
				<input  v-bind:value="calculator_input"  id="calculator_input" type="text" class="form-control rounded-0 rounded-top" style="text-align: right; font-size: 16pt;"> <!-- readonly -->
