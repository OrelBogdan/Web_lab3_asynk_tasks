...
describe('empty spec', () => {
  it('passes', () => {
    ...
    cy.visit('http://127.0.0.1:8080/calculator.html')
...
context('Location', () => {
  ...
  it('cy.location() - get window.location', () => {
    ...
    cy.location().should((location) => {
      ...
      expect(location.href).to.eq('http://127.0.0.1:8080/calculator.html')
      ...
      expect(location.pathname).to.eq('/calculator.html')
  ...
  it('cy.url() - get the current URL', () => {
    ...
    cy.url().should('eq', 'http://127.0.0.1:8080/calculator.html')
  })
})
